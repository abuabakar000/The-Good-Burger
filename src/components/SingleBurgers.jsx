...
import single from "../data/singleBurgers";

export default function SingleBurgers() {
  const [active, setActive] = useState(single[0]);

  return (
    <section id="burgers" className="bg-[#eef0e6] overflow-hidden">
