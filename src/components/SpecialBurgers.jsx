...
import special from "../data/specialBurgers";

export default function SpecialBurgers() {
  const [active, setActive] = useState(special[0]);

  return (
    <section id="special-burgers" className="bg-[#eef0e6] overflow-hidden">
